...
const report = {
	...
	surfaceEvidence: [
		...
		{ surface: "manual-anchor — source-key interpolation: span-endpoint anchors, duplicate keys (start/mid/end, triples, all-one-key, both-ends, non-emitted key, out-of-span pairs), single anchors, anchors bracketing no emitted row, keys on rows vs between rows, malformed tracks", refs: ["ANCH-endpoints-hold", "ANCH-endpoints-on-rows", "ANCH-out-of-span-hi-1", "ANCH-dup-mid-later-wins", "ANCH-dup-end-later-wins", "ANCH-dup-start-defect", "ANCH-dup-start-triple", "ANCH-dup-all-one-key", "ANCH-dup-start-out-of-span", "ANCH-dup-start-plus-out-of-span", "ANCH-dup-both-ends", "ANCH-dup-key-not-emitted", "ANCH-single-mid-hold", "ANCH-single-at-first-key", "ANCH-single-anchor-hold", "ANCH-bracket-none-midpoint", "ANCH-bracket-none-asymmetric", "ANCH-key-on-emitted-rows", "ANCH-key-between-rows", "ANCH-key-mix", "ANCH-track-dup-keys", "ANCH-track-unsorted"] },
